...
<form action="" method="post">
    <div class="container">
        ...
        <input type="text" name="name" disabled
            value="<?php echo isset($category['name']) ? $category['name'] : null ?>" />
        <br />
        <br />
        <span>Description</span><br />
        <textarea name="description"
            disabled><?php echo isset($category['description']) ? $category['description'] : null ?></textarea>
        <br />
        <br />
        <span>Salary</span><br />
        <input type="text" name="salary" disabled
            value="<?php echo isset($category['salary']) ? $category['salary'] : null ?>" />
        <br />
        <br />
        <span>Gender</span><br />
        ...
        <input type="text" name="birthday" disabled
            value="<?php echo isset($category['birthday']) ? $category['birthday'] : null ?>" />
        <br />
        <br />
